...
public interface IEmail {
    void SEmail(Email email, User receiver) throws Exception;

    void FEmail(Email email, User receiver) throws Exception;

    void REmail(Email replyEmail, Email email) throws Exception;
